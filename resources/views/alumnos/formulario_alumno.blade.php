...
<div class="container">
    ...
    <form method="POST" class="row" action="{{route('guarda_formulario')}}">
        ...
        <div class="form-group col-lg-4">
            ...
            <input type="text" placeholder="Apellido paterno" value="{{ old('ap_paterno') }}" name="ap_paterno">
            {!! $errors->first('ap_paterno','<span class="error_form">:message</span>') !!}
        </div>
        <div class="form-group col-lg-4">
            <label for="ap_materno">Apellido materno:</label>
            <input type="text" placeholder="Apellido materno" value="{{ old('ap_materno') }}" name="ap_materno">
            {!! $errors->first('ap_materno','<span class="error_form">:message</span>') !!}
        </div>
        <div class="form-group col-lg-4">
            <label for="matricula">Matricula :</label>
            <input type="number" placeholder="2000360101" value="{{ old('matricula') }}" name="matricula">
